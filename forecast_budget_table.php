...
// Add the single Grand Total row
...
$categoryTotals['Grand Total']['Annual Total'] = [
  ...
  'actual' => 0, // Section 3 doesn't show separate actual
      ...
      <div class="controls no-print">
        ...
        <div class="filter-section">
          ...
          <div style="display: flex; gap: 10px; flex-wrap: wrap;">
            ...
            <button class="btn-success" id="certifyBtn"><i class="fas fa-certificate"></i> Certify Report</button>
...
?>
        ...
        <div class="certification-section print-section">
          <div class="certification-header">
            Grant Certification
            <span class="certified-badge no-print"><i class="fas fa-check-circle"></i> Certified</span>
          </div>

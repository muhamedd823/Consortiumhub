...
<body>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action-buttons">
                                                        ...
                                                        <button class="action-button delete-button" onclick="deleteBudgetData(<?php echo $record['id']; ?>)">
            ...
            <div class="modal-body">
                <form method="POST" action="admin_fields_handler.php">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Required Fields -->
                        <div class="mb-4">
                            <label class="block text-gray-700 font-medium mb-2" for="edit_year">
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 font-medium mb-2" for="edit_period_name">
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 font-medium mb-2" for="edit_budget">
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 font-medium mb-2" for="edit_quarter_number">
                                <i class="fas fa-calendar-alt mr-2"></i>Quarter *
                            </label>
                            <select id="edit_quarter_number" name="quarter_number" class="form-select" required>
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 font-medium mb-2" for="edit_start_date">
                                <i class="fas fa-calendar-alt mr-2"></i>Start Date *
                            </label>
                            <input 
                                type="date" 
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 font-medium mb-2" for="edit_end_date">
                                <i class="fas fa-calendar-alt mr-2"></i>End Date *
                            </label>
                            <input 
                                type="date" 
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 font-medium mb-2" for="edit_cluster_select">
                                <i class="fas fa-building mr-2"></i>Cluster *
                            </label>
                            <select id="edit_cluster_select" name="cluster" class="form-select" required>
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 font-medium mb-2" for="edit_year2">
            ...
            <div class="modal-body">
                <form method="POST" action="admin_fields_handler.php">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 font-medium mb-2" for="year2_add">
                                <i class="fas fa-calendar mr-2"></i>Current Year *
                            </label>
                            <input 
                                type="number" 
    ...
    <div id="addBudgetPreviewModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="admin_fields_handler.php">
                    <input type="hidden" name="action" value="add_budget_preview">
            ...
            fetch('admin_fields_handler.php?action=get_budget_data&id=' + id)
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        document.getElementById('edit_id').value = data.record.id;
                        document.getElementById('view_id').value = data.record.id;
                        document.getElementById('edit_year').value = data.record.year;
                        document.getElementById('edit_category_name').value = data.record.category_name;
                        document.getElementById('edit_period_name').value = data.record.period_name;
                        document.getElementById('edit_budget').value = data.record.budget;
                        document.getElementById('edit_quarter_number').value = data.record.quarter_number;
                        // Ensure dates are in the correct format for date inputs (YYYY-MM-DD)
                        document.getElementById('edit_start_date').value = data.record.start_date ? data.record.start_date.split(' ')[0] : '';
                        document.getElementById('edit_end_date').value = data.record.end_date ? data.record.end_date.split(' ')[0] : '';
                        document.getElementById('edit_cluster_select').value = data.record.cluster;
                        document.getElementById('edit_year2').value = data.record.year2 || new Date().getFullYear();
